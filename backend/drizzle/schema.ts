import { pgTable, uuid, text, timestamp, varchar, foreignKey, unique, serial, primaryKey, pgEnum } from "drizzle-orm/pg-core"
import { sql } from "drizzle-orm"

export const pageItemType = pgEnum("page_item_type", ['block', 'field'])
...
export const collectionPages = pgTable("collection_pages", {
	...
	primaryKey({ columns: [table.collectionRefId, table.pageRefId], name: "collection_pages_collection_ref_id_page_ref_id_pk"}),
]);
